marketing_program_v2
==============================

Awesome marketing program with marketo and pardot
...
To run the tests, enter the marketing_program_v2/tests directory and run the following commands::
